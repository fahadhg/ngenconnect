    ...
    <aside className="w-56 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
      ...
      <div className="px-4 py-4 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 leading-tight">Canadian Manufacturing</p>
          </div>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all ${
                isActive
                  ? "bg-ngen-red/10 text-ngen-red"
                  : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
              }`}
            >
              <span className={isActive ? "text-ngen-red" : "text-gray-400"}>{icon}</span>
              {label}
            </Link>
          );
        })}
      ...
      <div className="border-t border-gray-100 p-3">
        <div className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg group">
          <div className="w-7 h-7 rounded-full bg-ngen-red/10 flex items-center justify-center flex-shrink-0">
            <span className="text-xs font-bold text-ngen-red uppercase">
          ...
          <button
            ...
            className="flex-shrink-0 text-gray-300 hover:text-ngen-red transition-colors"
            title="Sign out"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
